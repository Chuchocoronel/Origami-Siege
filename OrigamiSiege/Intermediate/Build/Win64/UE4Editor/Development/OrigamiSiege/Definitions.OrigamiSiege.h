...
#define UE_PROJECT_NAME OrigamiSiege
#define UE_TARGET_NAME OrigamiSiegeEditor
#define UE_MODULE_NAME "OrigamiSiege"
...
#define ORIGAMISIEGE_API DLLEXPORT
